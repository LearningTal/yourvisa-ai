        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">YourVisa.ai</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Enterprise-grade AI-powered visa processing platform. Reduce processing time from hours to minutes with our intelligent automation.
            </p>
